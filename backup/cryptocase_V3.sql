...
--
-- Хост: 127.0.0.1
-- Время создания: Сен 06 2025 г., 20:30
...
(3, 1000.00, 'USDT', 'test', '2025-09-06 18:23:41.490199', '2025-09-06 18:23:57.832222', 'test', 2, 3),
(4, 200.00, 'USDT', 'test2', '2025-09-06 18:25:08.048251', '2025-09-06 18:25:20.174841', 'test', 2, 3);
...
(3, '', '2025-09-04 16:05:06.531042', '2025-09-06 18:25:20.173844', 3, 2209.00, 1000.00, 201.00, 210.00),
...
--
-- Дамп данных таблицы `accounts_withdrawal`
--

INSERT INTO `accounts_withdrawal` (`id`, `amount_usd`, `method`, `details`, `created_at`, `processed_at`, `comment`, `status_id`, `user_id`) VALUES
(1, 10.00, 'USDT', 'test', '2025-09-06 13:31:27.209623', NULL, 'Tested model BD and view user', 2, 3);
...
(53, 'Can add Статус вывода', 14, 'add_withdrawalstatus'),
(54, 'Can change Статус вывода', 14, 'change_withdrawalstatus'),
(55, 'Can delete Статус вывода', 14, 'delete_withdrawalstatus'),
(56, 'Can view Статус вывода', 14, 'view_withdrawalstatus'),
(57, 'Can add withdrawal', 15, 'add_withdrawal'),
(58, 'Can change withdrawal', 15, 'change_withdrawal'),
(59, 'Can delete withdrawal', 15, 'delete_withdrawal'),
(60, 'Can view withdrawal', 15, 'view_withdrawal'),
(61, 'Can add deposit', 16, 'add_deposit'),
(62, 'Can change deposit', 16, 'change_deposit'),
(63, 'Can delete deposit', 16, 'delete_deposit'),
(64, 'Can view deposit', 16, 'view_deposit'),
(65, 'Can add Статус депозита', 17, 'add_depositstatus'),
(66, 'Can change Статус депозита', 17, 'change_depositstatus'),
(67, 'Can delete Статус депозита', 17, 'delete_depositstatus'),
(68, 'Can view Статус депозита', 17, 'view_depositstatus');
...
(2, 'Gold Rush Limited', 10.00, 500, 29, 1, NULL, NULL, 2),
(3, 'Happy Hour', 4.00, 0, 0, 1, '2025-09-04 15:25:00.000000', '2025-09-30 15:09:56.000000', 3),
(4, 'Anniversary Mega', 15.00, 100, 7, 1, '2025-09-04 15:26:17.000000', '2025-09-11 15:10:27.000000', 4);
...
(74, '2025-09-06 12:35:44.382454', 2, 5, 3),
(75, '2025-09-06 12:35:46.877573', 3, 8, 3),
(76, '2025-09-06 12:35:49.018573', 4, 11, 3);
...
(47, '2025-09-06 13:21:52.976919', '1', 'В ожидании (pending)', 1, '[{\"added\": {}}]', 14, 2),
(48, '2025-09-06 13:22:03.793970', '2', 'Подтверждено (approved)', 1, '[{\"added\": {}}]', 14, 2),
(49, '2025-09-06 13:22:14.130319', '3', 'Отклонено (rejected)', 1, '[{\"added\": {}}]', 14, 2),
(50, '2025-09-06 13:22:23.939416', '4', 'Отменено (cancelled)', 1, '[{\"added\": {}}]', 14, 2),
(51, '2025-09-06 13:31:27.211623', '1', 'Withdrawal<1> anton.fa01@mail.ru $10 [В ожидании (pending)]', 1, '[{\"added\": {}}]', 15, 2),
(52, '2025-09-06 13:31:57.611045', '1', 'Withdrawal<1> anton.fa01@mail.ru $10.00 [Подтверждено (approved)]', 2, '[{\"changed\": {\"fields\": [\"Status\"]}}]', 15, 2),
(53, '2025-09-06 18:14:47.819780', '1', 'В ожидании (pending)', 1, '[{\"added\": {}}]', 17, 2),
(54, '2025-09-06 18:14:57.376090', '2', 'Подтверждено (approved)', 1, '[{\"added\": {}}]', 17, 2),
(55, '2025-09-06 18:15:07.290947', '3', 'Отклонено (rejected)', 1, '[{\"added\": {}}]', 17, 2),
(56, '2025-09-06 18:15:16.716759', '4', 'Отменено (cancelled)', 1, '[{\"added\": {}}]', 17, 2),
(57, '2025-09-06 18:16:13.648996', '1', 'Deposit<1> anton.fa01@mail.ru $1000 [В ожидании (pending)]', 1, '[{\"added\": {}}]', 16, 2),
(58, '2025-09-06 18:16:35.650323', '1', 'Deposit<1> anton.fa01@mail.ru $1000.00 [Подтверждено (approved)]', 2, '[{\"changed\": {\"fields\": [\"Status\"]}}]', 16, 2),
(59, '2025-09-06 18:22:03.150279', '1', 'Deposit<1> anton.fa01@mail.ru $1000.00 [Подтверждено (approved)]', 3, '', 16, 2),
(60, '2025-09-06 18:22:41.925051', '2', 'Deposit<2> anton.fa01@mail.ru $1000 [В ожидании (pending)]', 1, '[{\"added\": {}}]', 16, 2),
(61, '2025-09-06 18:23:25.656076', '2', 'Deposit<2> anton.fa01@mail.ru $1000.00 [Отклонено (rejected)]', 3, '', 16, 2),
(62, '2025-09-06 18:23:41.491199', '3', 'Deposit<3> anton.fa01@mail.ru $1000 [В ожидании (pending)]', 1, '[{\"added\": {}}]', 16, 2),
(63, '2025-09-06 18:23:53.023945', '3', 'Deposit<3> anton.fa01@mail.ru $1000.00 [В ожидании (pending)]', 2, '[]', 16, 2),
(64, '2025-09-06 18:25:08.050251', '4', 'Deposit<4> anton.fa01@mail.ru $200 [В ожидании (pending)]', 1, '[{\"added\": {}}]', 16, 2);
...
(16, 'accounts', 'deposit'),
(17, 'accounts', 'depositstatus'),
(7, 'accounts', 'profile'),
(15, 'accounts', 'withdrawal'),
(14, 'accounts', 'withdrawalstatus'),
(1, 'admin', 'logentry'),
(3, 'auth', 'group'),
(2, 'auth', 'permission'),
(4, 'auth', 'user'),
...
(25, 'accounts', '0003_withdrawalstatus_withdrawal', '2025-09-06 13:16:58.396282'),
(26, 'accounts', '0004_depositstatus_deposit', '2025-09-06 18:13:56.602481');
